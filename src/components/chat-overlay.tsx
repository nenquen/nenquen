            ...
            messages.map((msg) => {
              ...
              return (
                <div key={msg.id} className="group flex flex-col gap-1 animate-in slide-in-from-bottom-2 fade-in duration-300">
                  ...
                  <div className="ml-7 w-fit max-w-[90%] rounded-2xl rounded-tl-sm border border-white/10 bg-white/5 px-4 py-2 text-sm text-zinc-200 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)]">
                    {msg.content}
                  </div>
                </div>
              );
        ...
        <div className="relative z-10 border-t border-white/5 bg-black/20 p-4">
          {!user ? (
            <div className="flex flex-col items-center gap-3">
              ...
              <button
                onClick={handleLogin}
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#5865F2]/30 bg-[#5865F2]/20 px-4 py-3 text-sm font-bold text-[#a5b0ff] shadow-[inset_0_1px_0_0_rgba(88,101,242,0.4)] transition-colors hover:bg-[#5865F2]/30 hover:text-white"
              >
